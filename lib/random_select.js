...
module.exports = function(weights, numToSelect) {
  ...
  if(weights.length < numToSelect) throw "Not enough items to select " + weights.length + " < " + numToSelect;
  ...
  if(selected.length < numToSelect) throw "Not enough weighted items " + selected.length + " < " + numToSelect;
